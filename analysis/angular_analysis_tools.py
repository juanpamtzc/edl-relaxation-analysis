...
# This function unwraps the positions of the hydrogens based on the positions of the oxygens using the minimum image convention
def unwrap_trj(positions_oxygens, positions_h1s, positions_h2s, data):
