...
if config['trajectory_type']=='process':
    ...
    plot_2d_heatmap(avg_com_transient_density.T, xlim=(0, time[-1]), ylim=(config['transient_density_profile']['zlo'], config['transient_density_profile']['zhi']), title="Average Transient COM Density Profile", xlabel="Time (fs)", ylabel="Z Position (Å)", colormap_label="Density (molecules/Å^3)", output_file=output_prefix+"_avg_transient_com_density.png")
    plot_2d_heatmap(avg_potassium_transient_density.T, xlim=(0, time[-1]), ylim=(config['transient_density_profile']['zlo'], config['transient_density_profile']['zhi']), title="Average Transient Potassium Density Profile", xlabel="Time (fs)", ylabel="Z Position (Å)", colormap_label="Density (ions/Å^3)", output_file=output_prefix+"_avg_transient_potassium_density.png")
    plot_2d_heatmap(avg_chloride_transient_density.T, xlim=(0, time[-1]), ylim=(config['transient_density_profile']['zlo'], config['transient_density_profile']['zhi']), title="Average Transient Chloride Density Profile", xlabel="Time (fs)", ylabel="Z Position (Å)", colormap_label="Density (ions/Å^3)", output_file=output_prefix+"_avg_transient_chloride_density.png")
