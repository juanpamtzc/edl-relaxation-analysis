...
plot_time_series(time, avg_com_density, title="Average COM Density Over Time", xlabel="Time (fs)", ylabel="Density (molecules/Å^3)", output_file=output_prefix+"_avg_com_density.png")
plot_time_series(time, avg_potassium_density, title="Average Potassium Density Over Time", xlabel="Time (fs)", ylabel="Density (ions/Å^3)", output_file=output_prefix+"_avg_potassium_density.png")
plot_time_series(time, avg_chloride_density, title="Average Chloride Density Over Time", xlabel="Time (fs)", ylabel="Density (ions/Å^3)", output_file=output_prefix+"_avg_chloride_density.png")
plot_time_series(time, avg_ionic_charge_density, title="Average Ionic Charge Density Over Time", xlabel="Time (fs)", ylabel="Charge Density (e/Å^3)", output_file=output_prefix+"_avg_ionic_charge_density.png")
