...
# fit smoothed splines to averaged data and find critical points
x_minima_com_density, y_minima_com_density, x_maxima_com_density, y_maxima_com_density, x_saddle_com_density, y_saddle_com_density, spline_com_density = find_critical_points_via_spline_fitting(time, avg_com_density, smoothing_factor=config['plotting_options']['water_density']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['water_density']['time_series']['spline_order'])
x_minima_potassium_density, y_minima_potassium_density, x_maxima_potassium_density, y_maxima_potassium_density, x_saddle_potassium_density, y_saddle_potassium_density, spline_potassium_density = find_critical_points_via_spline_fitting(time, avg_potassium_density, smoothing_factor=config['plotting_options']['potassium_density']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['potassium_density']['time_series']['spline_order'])
x_minima_chloride_density, y_minima_chloride_density, x_maxima_chloride_density, y_maxima_chloride_density, x_saddle_chloride_density, y_saddle_chloride_density, spline_chloride_density = find_critical_points_via_spline_fitting(time, avg_chloride_density, smoothing_factor=config['plotting_options']['chloride_density']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['chloride_density']['time_series']['spline_order'])
x_minima_ionic_charge_density, y_minima_ionic_charge_density, x_maxima_ionic_charge_density, y_maxima_ionic_charge_density, x_saddle_ionic_charge_density, y_saddle_ionic_charge_density, spline_ionic_charge_density = find_critical_points_via_spline_fitting(time, avg_ionic_charge_density, smoothing_factor=config['plotting_options']['ionic_charge_density']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['ionic_charge_density']['time_series']['spline_order'])
x_minima_oxygen_xx_stress, y_minima_oxygen_xx_stress, x_maxima_oxygen_xx_stress, y_maxima_oxygen_xx_stress, x_saddle_oxygen_xx_stress, y_saddle_oxygen_xx_stress, spline_oxygen_xx_stress = find_critical_points_via_spline_fitting(time, avg_oxygen_xx_stress, smoothing_factor=config['plotting_options']['oxygen_xx_stress']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['oxygen_xx_stress']['time_series']['spline_order'])
x_minima_oxygen_yy_stress, y_minima_oxygen_yy_stress, x_maxima_oxygen_yy_stress, y_maxima_oxygen_yy_stress, x_saddle_oxygen_yy_stress, y_saddle_oxygen_yy_stress, spline_oxygen_yy_stress = find_critical_points_via_spline_fitting(time, avg_oxygen_yy_stress, smoothing_factor=config['plotting_options']['oxygen_yy_stress']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['oxygen_yy_stress']['time_series']['spline_order'])
x_minima_oxygen_zz_stress, y_minima_oxygen_zz_stress, x_maxima_oxygen_zz_stress, y_maxima_oxygen_zz_stress, x_saddle_oxygen_zz_stress, y_saddle_oxygen_zz_stress, spline_oxygen_zz_stress = find_critical_points_via_spline_fitting(time, avg_oxygen_zz_stress, smoothing_factor=config['plotting_options']['oxygen_zz_stress']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['oxygen_zz_stress']['time_series']['spline_order'])
x_minima_interfacial_temperature, y_minima_interfacial_temperature, x_maxima_interfacial_temperature, y_maxima_interfacial_temperature, x_saddle_interfacial_temperature, y_saddle_interfacial_temperature, spline_interfacial_temperature = find_critical_points_via_spline_fitting(thermo_time, avg_interfacial_temperature, smoothing_factor=config['plotting_options']['interfacial_temperature']['time_series']['smoothing_factor'], spline_order=config['plotting_options']['interfacial_temperature']['time_series']['spline_order'])

# plot and save averaged densities
plot_time_series(time, avg_com_density, title="Average COM Density Over Time", xlabel="Time (fs)", ylabel="Density (molecules/Å^3)", output_file=output_prefix+"_avg_com_density.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_com_density) if equil_com_density is not None else None, benchmark_std=np.std(equil_com_density) if equil_com_density is not None else None, smoothed_data_fit=spline_com_density(time))
plot_time_series(time, avg_potassium_density, title="Average Potassium Density Over Time", xlabel="Time (fs)", ylabel="Density (ions/Å^3)", output_file=output_prefix+"_avg_potassium_density.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_potassium_density) if equil_potassium_density is not None else None, benchmark_std=np.std(equil_potassium_density) if equil_potassium_density is not None else None, smoothed_data_fit=spline_potassium_density(time))
plot_time_series(time, avg_chloride_density, title="Average Chloride Density Over Time", xlabel="Time (fs)", ylabel="Density (ions/Å^3)", output_file=output_prefix+"_avg_chloride_density.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_chloride_density) if equil_chloride_density is not None else None, benchmark_std=np.std(equil_chloride_density) if equil_chloride_density is not None else None, smoothed_data_fit=spline_chloride_density(time))
plot_time_series(time, avg_ionic_charge_density, title="Average Ionic Charge Density Over Time", xlabel="Time (fs)", ylabel="Charge Density (e/Å^3)", output_file=output_prefix+"_avg_ionic_charge_density.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_ionic_charge_density) if equil_ionic_charge_density is not None else None, benchmark_std=np.std(equil_ionic_charge_density) if equil_ionic_charge_density is not None else None, smoothed_data_fit=spline_ionic_charge_density(time))
plot_time_series(time, avg_oxygen_xx_stress, title="Average Oxygen XX Stress Over Time", xlabel="Time (fs)", ylabel="Stress", output_file=output_prefix+"_avg_oxygen_xx_stress.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_oxygen_xx_stress) if equil_oxygen_xx_stress is not None else None, benchmark_std=np.std(equil_oxygen_xx_stress) if equil_oxygen_xx_stress is not None else None, smoothed_data_fit=spline_oxygen_xx_stress(time))
plot_time_series(time, avg_oxygen_yy_stress, title="Average Oxygen YY Stress Over Time", xlabel="Time (fs)", ylabel="Stress", output_file=output_prefix+"_avg_oxygen_yy_stress.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_oxygen_yy_stress) if equil_oxygen_yy_stress is not None else None, benchmark_std=np.std(equil_oxygen_yy_stress) if equil_oxygen_yy_stress is not None else None, smoothed_data_fit=spline_oxygen_yy_stress(time))
plot_time_series(time, avg_oxygen_zz_stress, title="Average Oxygen ZZ Stress Over Time", xlabel="Time (fs)", ylabel="Stress", output_file=output_prefix+"_avg_oxygen_zz_stress.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_oxygen_zz_stress) if equil_oxygen_zz_stress is not None else None, benchmark_std=np.std(equil_oxygen_zz_stress) if equil_oxygen_zz_stress is not None else None, smoothed_data_fit=spline_oxygen_zz_stress(time))
plot_time_series(thermo_time, avg_interfacial_temperature, title="Average Interfacial Temperature Over Time", xlabel="Time (fs)", ylabel="Temperature (K)", output_file=output_prefix+"_avg_interfacial_temperature.png", xlim=xlim_timeseries, benchmark_mean=np.mean(equil_interfacial_temperature) if equil_interfacial_temperature is not None else None, benchmark_std=np.std(equil_interfacial_temperature) if equil_interfacial_temperature is not None else None, smoothed_data_fit=spline_interfacial_temperature(thermo_time))  
